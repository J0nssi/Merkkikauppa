        ...
        <>
            <form>
                ...
                <form>
                    ...
                    <input placeholder="Kuvan url" type="url" id="image_url" onChange={handleUrlChange} />
                    <button type="submit" id="btnAddUrl" disabled={urlState.length <= 0} onClick={handleUrlSubmit}>
                        Lisää kuvan url
                    </button>
                </form>
                ...
                <input placeholder="Hinta" id="price" type="number" min="0" onChange={handleChange} />
                <input placeholder="Määrä" id="item_count" type="number" min="1" onChange={handleChange} />
